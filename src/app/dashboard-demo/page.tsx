...
export default function DashboardDemoPage() {
  const user = mockUser;
  const userTournaments = mockTournaments;
  const announcements = mockAnnouncements.map(ann => ({
    ...ann,
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <Avatar className="h-16 w-16">
                <AvatarImage src={(user as any)?.avatarUrl || user?.avatar} alt={user?.displayName} />
