...
export default function SeedTournamentPage() {
  ...
  const seedTournament = async () => {
    ...
    try {
      ...
      setMessage('Creating 8 test users...');
      ...
      setMessage('Creating bracket matches...');
      ...
      setMessage('✅ Test tournament created successfully!');
      setLoading(false);
      ...
      setError(`Failed to create test tournament: ${err}`);
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto py-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle>Seed Test Tournament</CardTitle>
          <CardDescription>
            Create a test tournament with 8 players and a complete single-elimination bracket
            to verify the visual design improvements.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
              <li>8 test users (testuser1 through testuser8)</li>
              <li>Tournament: "UI Test Bracket (8 players)"</li>
              <li>7 bracket matches (Round 1: 4 matches, Semis: 2 matches, Final: 1 match)</li>
              <li>Mixed match states: completed (with scores), in-progress, and pending</li>
            </ul>
          </div>
          ...
          <Button
            ...
            className="w-full"
          >
            {loading ? 'Creating...' : 'Create Test Tournament'}
          </Button>

          <p className="text-xs text-muted-foreground text-center">
            After creation, you'll be redirected to the tournament page
          </p>
        </CardContent>
      </Card>
    </div>
